      ...
      <div className='grid gap-8 row-gap-10  sm:grid-cols-2 lg:grid-cols-2'>
        <div className='max-w-md items-center'>
          <p className='mb-3 text-center text-base text-gray-500 '>
            EV chargers management software - EV chargers setup (Networking and
            Chargers installations) EV chargers management software - EV
            chargers setup (Networking and Chargers installations)
          </p>
        </div>
