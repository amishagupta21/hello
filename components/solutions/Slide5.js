          ...
          <div className='relative rounded-2xl px-6 py-10  overflow-hidden  sm:px-12 sm:py-20'>
            ...
            <div className='relative'>
              <div className='sm:text-center'>
                <h2 className='text-2xl font-medium text-gray-600 tracking-tight sm:text-4xl leading-relaxed text-justify '>
                  If you want to grow your business with the help of our
                  innovative solutions then don’t think twice! You will never
                  regret collaborating with us. Reach us now!
                </h2>
              </div>
