      ...
      <div className="px-4 sm:my-24  my-8 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col lg:flex-row">
          <div className="max-w-xl sm:pr-16 mx-auto mb-10">
            ...
            <p className="mb-6 mt-12 text-gray-500">
          ...
          <div className="grid gap-5 row-gap-5 sm:grid-cols-2">
            <div className="max-w-md">
              <div className="flex items-center justify-center w-16 h-16 mb-4  rounded-full " style={{color : config.color.ub}}  >
               <svg xmlns="http://www.w3.org/2000/svg" width="47.505" height="25.422" viewBox="0 0 47.505 55.422">
