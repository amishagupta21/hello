...
export const Slide3 = () => {
  return (
    <div className='px-4 sm:my-24  my-8 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
      <div className='flex flex-col lg:flex-row'>
        <div className='max-w-xl sm:pr-16 mx-auto mb-10'>
          <h5 className='mb-6 text-3xl font-extrabold leading-none'>OCPP:</h5>
          <p className='mb-6 mt-12 text-gray-500  leading-relaxed text-justify '>
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem
            accusantium doloremque rem aperiam, eaque ipsa quae. Sed ut unde
            omnis iste natus. Sed ut perspiciatis unde omnis iste natus error
            sit voluptatem accusantium doloremque rem aperiam, eaque ipsa quae.
            Sed ut unde omnis iste natus. Sed ut perspiciatis unde omnis iste
