          ...
          <div className='relative max-w-8xl sm:pt-20 pt-16  mx-auto '>
            <div className='grid grid-cols-1 lg:grid-cols-3'>
              ...
              <div className='relative  py-10 px-6 bg-gray-100 sm:px-10 xl:p-12 '>
                ...
                <p className='mt-6 text-base  leading-relaxed text-justify text-black-500 max-w-3xl'>
                  Liked our approach ?<br></br>
                  Want to discuss your project ?<br></br>
              ...
              <div className='py-10 2xl:mx-48 xl:mx-28 mx-0    px-6 sm:px-10 lg:col-span-2 xl:p-12 bg-white'>
                <h3 className='text-lg font-medium text-gray-500'>
                  Let us work towards <strong>sustainabe</strong> and{' '}
                  <strong>greener</strong> enviromnet
                </h3>
                <form
                  data-botpoison-public-key='pk_000d7451-ff5a-4808-b059-63bc4c70b135'
                  action='https://submit-form.com/fh06ruIl'
