              ...
              <div className='mb-10 lg:max-w-lg lg:pr-5 lg:mb-0'>
                <div className='max-w-xl mb-6'>
                  ...
                  <p className='text-base text-gray-700 md:text-lg leading-relaxed text-justify'>
                    Manage and control your EV charging infrastructure using our
                    white label software. Our EV charging platform is fully
                    customized so you can decide on who will handle the specific
                    roles! We fit your residential or commercial needs so don’t
                    hesitate to hire our professionals for getting your
                    cloud-based EV charging platforms and app.
                  </p>
                </div>
